<%-- 
    ...
    Created on : Jun 28, 2021, 9:50:44 AM
    Author     : admin
--%>
...
<head>
    ...
    <link rel="stylesheet" href="./DoAnFile/Admin-BWD/assets/vendor/select2/css/select2.css">
    <link rel="stylesheet" href="./DoAnFile/Admin-BWD/assets/vendor/summernote/css/summernote-bs4.css">
...
<body>
                    ...
                    <div class="email-compose-fields">
                            ...
                            <div class="form-group row pt-0">
                                ...
                                <div class="col-md-11">
                                    <select class="js-example-basic-multiple" multiple="multiple">
                                        <option value="Yellow" selected="selected">nvtung.20it5@vku.udn.vn</option>
                                        <option value="White">vku.udn.vn</option>
                                        <option value="Blue" selected="selected">vku.udn.vn</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="to cc">
                            <div class="form-group row pt-2">
                                ...
                                <div class="col-md-11">
                                    <select class="js-example-basic-multiple" multiple="multiple">
                                        <option value="Alabama">nnhau.20it2@vku.udn.vn</option>
                                        <option value="Alaska" selected="selected">vku.udn.vn</option>
                                        <option value="Melbourne">Melbourne</option>
                                        <option value="Victoria" selected="selected">ngochautk123@gmail.com</option>
    ...
    <script src="./DoAnFile/Admin-BWD/assets/vendor/select2/js/select2.min.js"></script>
    <script src="./DoAnFile/Admin-BWD/assets/vendor/summernote/js/summernote-bs4.js"></script>
