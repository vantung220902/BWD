...
<html lang="en">
    ...
    <body>
        <%
            ...
            if (acc == null) {
                acc = new Account("", "", "", 0, DateConver.now(), true, "", "", "", "user", DateConver.now());
            }
        %>
        <!-- ============================================================== -->
        <!-- main wrapper -->
                                ...
                                <div class="container">
                                    ...
                                    <form action="AccServlet" class="sign-up-form" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="<%=acc.getUsername()%>" name="username" placeholder="Tên Đăng Nhập" > 
                                    </div>
                                    <div class="form-group">
                                        <i class="fas fa-envelope"></i>
                                        <input class="form-control" type="text" value="<%=acc.getEmail()%>" placeholder="Email" name="email" > 
                                    </div>
                                    <div class="form-group">
                                        <i class="fas fa-lock"></i>
                                        <input class="form-control" type="password" value="<%=acc.getPassword()%>" placeholder="Password" name="password" > 
                                    </div>
                                    <div class="form-group">
                                        <i class="fas fa-lock"></i>
                                        <input class="form-control"type="text" value="<%=acc.getFullname()%>" placeholder="Tên" name="fullname" > 
                                    </div>

                                    <div class="form-group">
                                        <i class="fas fa-lock"></i>
                                        <input class="form-control"type="text" value="<%=acc.getAge()%>" placeholder="Tuổi" name="age" > 
                                    </div>
                                    <div class="form-group">
                                        <i class="fas fa-lock"></i>
                                        <input class="form-control"type="date" value="<%=acc.getBirthday()%>" placeholder="Ngày Sinh" name="birthday"> 
                                    </div>
                                    <div class="form-group">
                                        <i class="fas fa-lock"></i>
                                        <input class="form-control"type="text" value="<%=acc.getPhone()%>" placeholder="Số Điện Thoại" name="phone" > 
                                    </div>

                                    <div class="form-group">
                                        <i class="fas fa-lock"></i>
                                        <input class="form-control"type="text" value="<%=acc.getAddress()%>" placeholder="Địa Chỉ" name="address" > 
                                    </div>
